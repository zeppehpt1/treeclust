...
def extract_predicted_crowns_from_aois(aois_dir:str, gt_crowns_filepath:str, name_base:str, epsg:int):
...
def extract_crowns_with_labels_from_aois(aois_dir:str, gt_crowns_filepath:str, name_base:str, epsg:int):
...
def create_mask_from_shapefile(shapefile_filepath, corresponding_orthomosaic_filepath, output_path):
